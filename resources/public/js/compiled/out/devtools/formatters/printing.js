...
var len__4736__auto___22955 = arguments.length;
var i__4737__auto___22956 = (0);
while(true){
if((i__4737__auto___22956 < len__4736__auto___22955)){
args__4742__auto__.push((arguments[i__4737__auto___22956]));

var G__22957 = (i__4737__auto___22956 + (1));
i__4737__auto___22956 = G__22957;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22952){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22953,G__22954,seq22952__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22958_SHARP_){
return (!((cljs.core.meta.call(null,p1__22958_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22959__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22963){var _e__22186__auto__ = e22963;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22965){var _e__22186__auto__ = e22965;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22967 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22968 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22968);

try{var map__22969 = opts;
...
var markup_db = cljs.core.get.call(null,map__22969__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22967);
}});
...
var temp__5718__auto___22974 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___22974)){
var managed_print_level_22975 = temp__5718__auto___22974;
var _STAR_print_level_STAR__orig_val__22972_22976 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22973_22977 = managed_print_level_22975;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22973_22977);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22971_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22971_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22972_22976);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1635174922089
