...
var o22821 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22821["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22822 = temp__5718__auto____$1;
return (o22822["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22179__auto__ = f;
return (o__22179__auto__["toString"]).call(o__22179__auto__);
} else {
return "";
}
}catch (e22823){var _ = e22823;
return "";
}});
...
try{var o__22179__auto___22825 = t;
(o__22179__auto___22825["cljs$lang$ctorPrWriter"]).call(o__22179__auto___22825,t,writer);
}catch (e22824){var __22826 = e22824;
}
...
var char_code = (function (){var o__22179__auto__ = (new String(char$));
return (o__22179__auto__["charCodeAt"]).call(o__22179__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22179__auto__ = String;
return (o__22179__auto__["fromCharCode"]).call(o__22179__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22827 = num_code;
switch (G__22827) {
case (1):
return (185);
...
var o__22179__auto__ = String;
return (o__22179__auto__["fromCharCode"]).call(o__22179__auto__,superscript_code);
});
/**
...
}catch (e22829){var _e__22186__auto__ = e22829;
return false;
}})())){
...
var vec__22830 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22830,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22833 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22833["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22834 = temp__5718__auto____$1;
return (o22834["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___22841 = arguments.length;
var i__4737__auto___22842 = (0);
while(true){
if((i__4737__auto___22842 < len__4736__auto___22841)){
args__4742__auto__.push((arguments[i__4737__auto___22842]));

var G__22843 = (i__4737__auto___22842 + (1));
i__4737__auto___22842 = G__22843;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22837){
var vec__22838 = p__22837;
var ns_detector = cljs.core.nth.call(null,vec__22838,(0),null);
...
var G__22844 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22845 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22844;
remaining_tokens = G__22845;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22835){
...
var vec__22849 = cljs.core.split_with.call(null,(function (p1__22848_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22848_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22849,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22849,(1),null);
...
var vec__22855 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22855,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22855,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22858 = cljs.core.rest.call(null,remaining_tokens);
var G__22859 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22858;
name_tokens = G__22859;
continue;
} else {
...
var vec__22862 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22862,(0),null);
var arity = cljs.core.nth.call(null,vec__22862,(1),null);
var vec__22865 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22865,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22865,(1),null);
var vec__22868 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22868,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22868,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22868,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22868,(3),null);
...
var vec__22874 = result;
var munged_ns = cljs.core.nth.call(null,vec__22874,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22874,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22874,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22874,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22874,(4),null);
var arity = cljs.core.nth.call(null,vec__22874,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22878 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22878,(0),null);
var args = cljs.core.nth.call(null,vec__22878,(1),null);
var vec__22881 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22881,(0),null);
var name = cljs.core.nth.call(null,vec__22881,(1),null);
...
var G__22884 = (arity + (1));
var G__22885 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22886){
var vec__22887 = p__22886;
var arity = cljs.core.nth.call(null,vec__22887,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22887,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22890_SHARP_){
return cljs.core.get.call(null,arities,p1__22890_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22891_SHARP_){
return cljs.core.drop.call(null,(2),p1__22891_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22898 = arguments.length;
var i__4737__auto___22899 = (0);
while(true){
if((i__4737__auto___22899 < len__4736__auto___22898)){
args__4742__auto__.push((arguments[i__4737__auto___22899]));

var G__22900 = (i__4737__auto___22899 + (1));
i__4737__auto___22899 = G__22900;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22894){
var vec__22895 = p__22894;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22895,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22892){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22903__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22903__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22903__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22903__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22904 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22904,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22904,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22904,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22904,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22904,(4),null);
var arity = cljs.core.nth.call(null,vec__22904,(5),null);
...
var o__22179__auto__ = f;
return (o__22179__auto__["getBasis"]).call(o__22179__auto__);
});
/**
...
}catch (e22908){var _e__22186__auto__ = e22908;
...
var G__22909 = (obj[cljs.core.first.call(null,path)]);
var G__22910 = cljs.core.rest.call(null,path);
obj = G__22909;
path = G__22910;
continue;
} else {
...
var _STAR_ = (function (accum,p__22911){
var vec__22912 = p__22911;
var bit = cljs.core.nth.call(null,vec__22912,(0),null);
var protocol = cljs.core.nth.call(null,vec__22912,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22915){
var vec__22916 = p__22915;
var ns = cljs.core.nth.call(null,vec__22916,(0),null);
var name = cljs.core.nth.call(null,vec__22916,(1),null);
var selector = cljs.core.nth.call(null,vec__22916,(2),null);
...
var post_process = (function (p__22920){
var vec__22921 = p__22920;
var munged_name = cljs.core.nth.call(null,vec__22921,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22921,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22919_SHARP_){
return (obj[cljs.core.first.call(null,p1__22919_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1635174921879
