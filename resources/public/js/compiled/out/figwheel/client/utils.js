...
return (new CustomEvent(event_name,(function (){var obj28535 = ({"detail":data});
return obj28535;
})()));
} else {
...
var f = (function (){var pred__28542 = cljs.core._EQ_;
var expr__28543 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28542.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28543))){
return (function (p1__28536_SHARP_){
return console.warn(p1__28536_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28542.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28543))){
return (function (p1__28537_SHARP_){
return console.debug(p1__28537_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28542.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28543))){
return (function (p1__28538_SHARP_){
return console.error(p1__28538_SHARP_);
});
} else {
return (function (p1__28539_SHARP_){
return console.log(p1__28539_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28546){
...
var opts = map__28547__$1;
var eval_fn = cljs.core.get.call(null,map__28547__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28549_SHARP_){
return new_def.callback(p1__28549_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28550){
var vec__28551 = p__28550;
var ky = cljs.core.nth.call(null,vec__28551,(0),null);
var v = cljs.core.nth.call(null,vec__28551,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1635174927023
